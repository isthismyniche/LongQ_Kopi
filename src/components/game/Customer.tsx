      ...
      <div className="relative">
        ...
        {isFirst && (
          <div className="absolute bottom-full left-1/2 -translate-x-1/2 flex flex-col items-center pb-3 z-10 pointer-events-none w-max">
            ...
            {/* Speech bubble */}
            <motion.div
              className={`relative px-3 py-2 rounded-xl border-2 shadow-md max-w-[210px] ${speechBg}`}
              initial={{ scale: 0, opacity: 0 }}
              animate={{ scale: 1, opacity: 1 }}
              transition={{ delay: 0.2, type: 'spring' }}
            >
              <p className="text-lg font-bold text-kopi-brown text-center leading-tight font-display">
                {speechText}
              </p>
